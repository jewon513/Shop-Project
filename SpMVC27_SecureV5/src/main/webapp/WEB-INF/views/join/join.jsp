...
<body>
	...
	<div class="container body">
		...
		">
			<form:form method="POST" action="${rootPath}/join/join_next" class="join_form border shadow" modelAttribute="userVO">

				<h2>회원가입</h2>

				<form:input type="text" path="username" placeholder="사용자 ID" />
				<div class="message" id="m_username"></div>
				<form:input type="password" path="password" placeholder="비밀번호" />
